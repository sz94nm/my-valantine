...
;(function (window) {
    ...
    GridFx.prototype._setClone = function (src, settings) {
        if (!src) {
            ...
            this.cloneImg.style.top = settings.top + 48 + 'px';
    ...
    GridFx.prototype._closeItem = function () {
        ...
        var win = this._getWinSize(),
            ...
            dy = gridImgOffset.top - 48 + gridImg.offsetHeight / 2 - ((this.options.imgPosition.y > 0 ? 1 - Math.abs(this.options.imgPosition.y) : Math.abs(this.options.imgPosition.y)) * win.height + this.options.imgPosition.y * win.height / 2),
